...
export class SecondStepCompletion extends Scene {
    constructor() {
    ...
    async preload() {
        return new Promise((resolve) => {
            ...
            setTimeout(() => {
                console.log("SecondStepCompletion: Assets preloaded.");
                resolve();
            }, 1000);
        });
    }
    ...
    start() {
        ...
        this._wrapperDiv.innerHTML = `
            <div id="container" class="container hint text-center">
                <img src="public/img/emojie-smiley.png" alt="Personnage" height="150" />
                <br/>
                <br/>
                <div id="text-content">
        ...
        const paragraphs = [
            " 🎉 ... Félicitation .... 🎊, \n votre second mission à été effectuée avec brio 🥳.\n La prochaine aventue ? C'est par ici 👇",
